<?php
namespace Modules\PreProject\Services\Filters;
...
/**
 * Class PreProjectName
 * @package Modules\PreProject\Services\Filters
 */
class PreProjectName extends FilterAbstract implements CriteriaInterface {
    /**
     * @var array
     */
    protected $predicate;
