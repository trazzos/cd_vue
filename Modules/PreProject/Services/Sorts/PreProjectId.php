<?php
namespace Modules\PreProject\Services\Sorts;
...
/**
 * Class PreProjectId
 * @package Modules\PreProject\Services\Sorts
 */
class PreProjectId extends SortAbstract implements CriteriaInterface {
    /**
     * @var array
     */
    protected $sort;
